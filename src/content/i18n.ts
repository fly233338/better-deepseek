...
const messages = {
  'zh-CN': {
    ...
    'popup.copyDiagnostics': '复制诊断信息',
    'popup.copyDone': '诊断信息已复制',
    'popup.diagnosticEnabled': '启用状态',
    'popup.diagnosticFoldersOpen': '文件夹展开',
    'popup.diagnosticLocale': '语言',
    'popup.diagnosticMounted': '页面注入',
    'popup.diagnosticPromptOpen': '提示词库打开',
    'popup.diagnosticTab': '当前页面',
    'popup.diagnosticTime': '时间',
    'popup.diagnosticUserAgent': '浏览器',
    'popup.diagnosticVersion': '版本',
    'popup.disable': '禁用 Better DeepSeek',
    'popup.disabled': '已禁用',
    'popup.enable': '启用 Better DeepSeek',
    'popup.enabled': '已启用',
    'popup.exportBackup': '导出备份',
    'popup.importBackup': '导入备份',
    'popup.noDeepSeekTab': '当前标签页不是 DeepSeek 聊天页',
    'popup.off': '关闭',
    'popup.on': '开启',
    'popup.openFolders': '打开文件夹',
    'popup.openPromptLibrary': '打开提示词库',
    'popup.reloadPageHint': '如页面未响应，请刷新 DeepSeek 标签页。',
    'popup.resetDone': 'UI 已重置',
    'popup.resetUi': '重置 UI',
    'popup.saved': '已保存',
    'popup.title': 'Better DeepSeek',
    'popup.toggleFoldersOff': '关闭文件夹',
    'popup.togglePromptLibraryOff': '关闭提示词库',
  ...
  'en-US': {
    ...
    'popup.copyDiagnostics': 'Copy Diagnostics',
    'popup.copyDone': 'Diagnostics copied',
    'popup.diagnosticEnabled': 'Enabled',
    'popup.diagnosticFoldersOpen': 'Folders open',
    'popup.diagnosticLocale': 'Locale',
    'popup.diagnosticMounted': 'Page mounted',
    'popup.diagnosticPromptOpen': 'Prompt library open',
    'popup.diagnosticTab': 'Current tab',
    'popup.diagnosticTime': 'Time',
    'popup.diagnosticUserAgent': 'Browser',
    'popup.diagnosticVersion': 'Version',
    'popup.disable': 'Disable Better DeepSeek',
    'popup.disabled': 'Disabled',
    'popup.enable': 'Enable Better DeepSeek',
    'popup.enabled': 'Enabled',
    'popup.exportBackup': 'Export Backup',
    'popup.importBackup': 'Import Backup',
    'popup.noDeepSeekTab': 'The current tab is not a DeepSeek chat page',
    'popup.off': 'Off',
    'popup.on': 'On',
    'popup.openFolders': 'Open Folders',
    'popup.openPromptLibrary': 'Open Prompt Library',
    'popup.reloadPageHint': 'If the page does not respond, refresh the DeepSeek tab.',
    'popup.resetDone': 'UI reset',
    'popup.resetUi': 'Reset UI',
    'popup.saved': 'Saved',
    'popup.title': 'Better DeepSeek',
    'popup.toggleFoldersOff': 'Close Folders',
    'popup.togglePromptLibraryOff': 'Close Prompt Library',
